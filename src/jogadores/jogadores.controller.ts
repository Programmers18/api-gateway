...
export class JogadoresController {
    ...
    async criarJogador(@Body() criarJogadorDto: CriarJogadorDto) {
        ...
        let categoria = await this.clientAdminBackend
            .send<Categoria>('consultar-categorias', criarJogadorDto.categoria)
            .toPromise()
    ...
    async uploadArquivos(@UploadedFile() file, @Param('_id') _id: string) {
    ...
    async atualizarJogador(
        ...
        const categoria$ = this.clientAdminBackend.send<Categoria>(
